...
static void ulpatch_args_reset(void)
{
	target_pid = -1;
	target_task = NULL;
	patch_file = NULL;
...
static int print_help(void)
{
	...
	"\n"
	" ulpatch is the core tool of ULPatch, which is used to manage the \n"
	" patch of the target process, including patch loading, patch unloading,\n"
	" and multi-patch management.\n"
	"\n"
	" Option argument:\n"
	"\n"
